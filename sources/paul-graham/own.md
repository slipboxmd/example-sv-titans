...
the best ways to discover
 __startup ideas__is to work on a project
just for fun.
 ...
 *real*work — work that one is not to be judged by — but originally it just
...
was to acquire
 __credentials__while ascending some predefined ladder.
