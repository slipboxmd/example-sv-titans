...
in the body has a spam probability of only 65%. Case is preserved.
 ...
 *one*feature, not one for each word.  I need to handle case in a
...
guess wrong.
 *Look*at where your code is slow,
