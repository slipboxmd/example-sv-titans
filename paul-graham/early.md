...
to your imagination — not just to have lower standards, but to
 __switch polarity__entirely, from listing 
...
kept me going while I was working on
 __Bel__. Having worked for so long
...
that historically the Bay Area has attracted a
 __different sort of person__than, 
say, New York City.
 [2]
...
new with little upfront commitment.*a feature*. "Yes, it's a bit ridiculous, right?  I'm just trying
...
John Carmack adds:
  ...
  hacks to try out a gameplay idea weren't all [7]
Lisa Randall suggests that we*that*far from the
